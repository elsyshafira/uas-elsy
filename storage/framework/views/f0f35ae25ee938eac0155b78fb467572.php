    ...
    <div class="container">
        ...
        <form action="<?php echo e(url('/produk')); ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="produk_stok" class="form-control" placeholder="Nomor stok">
            </div>
            <div class="mb-3">
                <label for="">KETERANGAN</label>
                <input type="text" name="produk_keterangan" class="form-control" placeholder="Nomor Keterangan">
            </div>
            <div class="mb-3">
