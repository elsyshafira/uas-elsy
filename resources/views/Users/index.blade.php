...
@section('content')
    <div class="container">
        ...
        @endif
        <a class="btn btn-secondary btn-sm float-end" href="{{ url('users/create')}}">Tambah Data</a>
        <table class="table table-success table-striped">
            ...
            <tr>
                ...
                <td>{{ $row->user_hp}}</td>
                <td><a class="btn btn-success btn-sm float" href="{{url('users/' .$row->user_id. '/edit')}}">Edit</a></td>
                <td>
